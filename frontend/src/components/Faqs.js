...
const FAQs = () => {
  return (
    <div className="mx-auto bg-black font-['Montserrat'] py-10">
      ...
      <div className="row md:mx-auto px-2 md:px-32">
        <div className="p-8 rounded overflow-hidden">
          <hr className="my-3" />
          <div className="group outline-none accordion-section" tabindex="1">
            ...
            <div className="group-focus:max-h-screen max-h-0 bg-gray-800 px-4 overflow-hidden ease duration-500">
              <p className="p-2 text-[#ffffff99] text-justify md:text-lg text-base">
