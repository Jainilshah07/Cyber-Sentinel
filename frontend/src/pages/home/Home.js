  ...
  return (
    ...
    <div className="flex flex-col items-center">
      <div className="p-4 bg-yellow-200 rounded-full">
        <svg className="w-24 text-yellow-600 animate-pulse" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div className="flex flex-col items-center">
      <div className="p-4 bg-blue-200 rounded-full">
        <svg className="w-24 text-blue-600 animate-spin-slow" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div className="flex flex-col items-center">
      <div className="p-4 bg-green-200 rounded-full">
        <svg className="w-24 text-green-600 animate-wiggle" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
