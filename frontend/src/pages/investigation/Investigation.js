    ...
    <div>
      <div className="row border-b-2 border-black">
        <div className="grid grid-cols-1 md:grid-cols-3 bg-slate-200 px-5 md:px-8">
          ...
          <div className="col-span-1 h-20 flex">
            <p className="my-auto font-semibold mx-auto">
              Submit For Investigation{" "}
            </p>
            <button
              onClick={submitHandler}
              className="my-auto h-10 tracking-wide font-semibold bg-[#0e0667] text-gray-100 w-40 rounded-lg hover:bg-black transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none"
            >
